        ...
        <div className="absolute z-10 inset-x-0 bottom-0
            ...
            <div className="w-full h-16 px-8 mx-auto
                ...
                <div className="flex content-around items-center">
                    ...
                    <FontAwesomeIcon className="text-custom-100 m-2 hover:text-custom-200 cursor-pointer" size="lg" icon={faFacebook} />
                    <FontAwesomeIcon className="text-custom-100 m-2 hover:text-custom-200 cursor-pointer" size="lg" icon={faTwitter} />
                    <FontAwesomeIcon className="text-custom-100 m-2 hover:text-custom-200 cursor-pointer" size="lg" icon={faPinterest} />
                </div>
